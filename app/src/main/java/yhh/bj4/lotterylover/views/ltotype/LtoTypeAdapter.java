package yhh.bj4.lotterylover.views.ltotype;
 ...
 */
public class LtoTypeAdapter extends RecyclerView.Adapter {

    public interface Callback {
        void onLtoTypeChanged(int ltoType);
    }
    ...
    public LtoTypeAdapter(Context context, Callback cb, int selectedPosition) {
        mContext = context;
        mCallback = cb;
        mItems = context.getResources().getStringArray(R.array.action_bar_spinner_lto_type);
        mSelectedPosition = selectedPosition;
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(((LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.lto_type_item, null));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        textHolder.mText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                notifyItemChanged(mSelectedPosition);
                mCallback.onLtoTypeChanged(mSelectedPosition);
            }
        });
    }
